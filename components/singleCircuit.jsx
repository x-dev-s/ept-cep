...
export default function SingleCircuit() {
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      if (!isInductanceProvided || !isCapacitanceProvided) {
        if (data.number_of_bundled_conductors === 2) { ds = Math.sqrt(r_dash * data.bundle_spacing); }
      ...
      const power_mw = data.power * data.power_factor;
  ...
  return (
    <div className="flex flex-col justify-center gap-10">
      ...
      <h1 className="text-4xl font-extrabold font-mono text-center">SINGLE CIRCUIT SYSTEM</h1>
